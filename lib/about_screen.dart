...
const String _sourcesAzbyka =
    ' — оттам са Свещеното Писание, житията на светиите по св. Димитрий '
...
const String _sourcesKotyuk =
    ' — руското приложение „Православный календарь" на Oleksandr Kotyuk, с '
    'отворен код. Оттам са четивата в раздела „Справочник", а също и '
    'устройството на дневния изглед с разгъващите се секции.';

const String _sourcesTranslation =
    'Руските текстове са преведени машинно и след това преглеждани. '
