...
/// текст.
///
/// „ѝ" (U+045D) и „Ѝ" (U+040D) вече ги НЯМА в тази бройка — вградени са
/// направо в Tamburin (17.08.2026, `tools/fonts/patch_tamburin_izh.py`,
/// сглобени геометрично от „и"/„И" + вече съществуващия глиф `grave`).
/// Остава само комбиниращото ударение (U+0301, среща се веднъж — в
/// „Тео́фил"): в шрифта няма никакъв елемент, годен за акутно ударение, и то
/// си остава на Charis SIL.
///
/// Резервът важи ЗА ОТДЕЛЕН ГЛИФ, не за целия надпис: заглавието си остава
/// Tamburin, само този знак идва от Charis.
