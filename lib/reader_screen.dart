...
import 'reader_hram_extension.dart';
...
class _ReaderScreenState extends State<ReaderScreen>
  ...
  ///
  /// ⚠ Живее в СВОЙ файл, защото мястото ѝ иска ИЗРИЧЕН спан — виж
  /// reader_hram_extension.dart защо `TagExtension` не върши работа.
  HtmlExtension get _hramExtension => ReaderHramExtension(_ink);
