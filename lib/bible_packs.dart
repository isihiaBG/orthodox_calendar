...
///
/// ⚠ Ползва се при разчитане на споделен адрес: линк с `@g` трябва да
/// отвори гръцкия, а не да съобщи „непознат превод". Приравняването става
/// САМО ако новият пакет е налице — инак човек, който още има стария, би
/// получил предложение да сваля нещо, което вече чете.
String greekCanonical(String code, Set<String> installed) =>
    kGreekLegacy.contains(code) && installed.contains('el') ? 'el' : code;
