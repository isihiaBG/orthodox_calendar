...
⚠⚠ ИМЕТО КАЗВА И ДВЕТЕ: че пакетът носи ЦЯЛОТО Писание И че Старият завет е
по Септуагинта. Първият опит беше „Гръцки (Старият завет по Септуагинта)" и
се чете точно обратно на истината — сякаш вътре има само Стар завет, тоест
пресъздава недоразумението, което сливането премахва. Краткото име, с което
човек си избира превод в лентата, остава само „Гръцки".
⚠ Разликата не е дребна: гръцкият Стар завет по Септуагинта се разминава с
масоретския и по номерация, и по състав. (Бележки на потребителя,
11.09.2026.)
...
НОВ = "el"
ПЪЛНО = "Гръцки (Нов и Стар завет, като Старият завет е по Септуагинта)"
КРАТКО = "Гръцки"
СЪКР = "гр"
