...
TARGETED = [
    # Съдържанието на октомврийския том. Моделът е превел „Память N
    # октября" като „Помен на N октомври" — само тук и само в toc.ncx;
    # в самия текст на тома и в другите единайсет навсякъде е „Памет".
    # Проверено на 14.08.2026: в останалите съдържания няма нито един
    # такъв случай, нито разминат месец, нито останала руска буква.
    ("10(окт)", "meta_toc", "Помен на", "Памет на"),
